...
var EntryRow = function EntryRow(props) {
	return React.createElement(
		...
		React.createElement(
			'td',
			null,
			props.entry.createdDate ? props.entry.createdDate.toDateString() : ''
		),
		React.createElement(
			'td',
			null,
			props.entry.fastingBGL
		),
		React.createElement(
			'td',
			null,
			props.entry.breakfast
		),
		React.createElement(
			'td',
			null,
			props.entry.postBreakfastBGL
		),
		React.createElement(
			'td',
			null,
...
function EntryTable(props) {
	var entryRows = props.entries.map(function (entry) {
		return React.createElement(EntryRow, { key: entry._id, entry: entry });
	});
